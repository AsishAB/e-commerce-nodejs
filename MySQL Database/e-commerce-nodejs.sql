...
INSERT INTO `tbl_cart` VALUES (1,'1','2022-05-14 15:41:34',NULL),(2,'1','2022-05-14 15:43:58',NULL),(3,'1','2022-05-16 09:45:48',NULL);
...
INSERT INTO `tbl_cart_items` VALUES (3,'1','3','4',NULL,NULL,'1');
...
--
-- Temporary view structure for view `vw_order_details-backup`
--

DROP TABLE IF EXISTS `vw_order_details-backup`;
/*!50001 DROP VIEW IF EXISTS `vw_order_details-backup`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_order_details-backup` AS SELECT 
 1 AS `TO_Id`,
 1 AS `TO_Order_Id`,
 1 AS `TO_User_Id`,
 1 AS `TO_Net_Price`,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_order_details` AS select `toi`.`TOI_Id` AS `TOI_Id`,`toi`.`TOI_Order_Id` AS `TOI_Order_Id`,`toi`.`TOI_Product_Id` AS `TOI_Product_Id`,`toi`.`TOI_Quantity` AS `TOI_Quantity`,`toi`.`TOI_Created_On` AS `TOI_Created_On`,`toi`.`TOI_Updated_On` AS `TOI_Updated_On`,`tp`.`TP_ProductId` AS `TP_ProductId`,`tp`.`TP_Product_Title` AS `TP_Product_Title`,`tp`.`TP_Product_Description` AS `TP_Product_Description`,`tp`.`TP_Image_URL` AS `TP_Image_URL`,`tp`.`TP_Product_Price` AS `TP_Product_Price`,`tp`.`TP_Product_DeletedFlag` AS `TP_Product_DeletedFlag` from (`tbl_order_items` `toi` join `tbl_products` `tp` on((`tp`.`TP_ProductId` = `toi`.`TOI_Product_Id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_order_details-backup`
--
